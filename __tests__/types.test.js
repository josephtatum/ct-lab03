...
describe('validator module', () => {
  describe('basic validation', () => {
    it.skip('properly tells if a value is a numbers', () => {
    ...
    it.skip('properly tells if a value is a string', () => {
    ...
    it.skip('properly tells if a value is a boolean', () => {
    ...
    it.skip('properly tells if a value is an object', () => {
    ...
    it.skip('properly tells if a value is an array', () => {
    ...
    it.skip('properly tells if a value is a function', () => {
  ...
  describe('casters', () => {
    it.skip('can cast values to a number', () => {
    ...
    it.skip('throws if value is not castable to number', () => {
      expect(() => castToNumber('hi')).toThrowErrorMatchingSnapshot();
      expect(() => castToNumber({})).toThrowErrorMatchingSnapshot();
    });

    it.skip('can cast values to a string', () => {
    ...
    it.skip('throws if value is not castable to string', () => {
      expect(() => castToString({})).toThrowErrorMatchingSnapshot();
      expect(() => castToString(() => {})).toThrowErrorMatchingSnapshot();
    });

    it.skip('can cast values to a boolean', () => {
    ...
    it.skip('throws if value is not castable to boolean', () => {
      expect(() => castToBoolean({})).toThrowErrorMatchingSnapshot();
      expect(() => castToBoolean(() => {})).toThrowErrorMatchingSnapshot();
    });

    it.skip('can cast values to an array', () => {
      expect(castToArray(castToString)(['hi', 'there', 3])).toEqual(['hi', 'there', '3']);
    });

    it.skip('throws if value is not castable to an array', () => {
  ...
  it.skip('can get the right caster', () => {
